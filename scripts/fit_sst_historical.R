...
## 2022-03-08
## region    species       variable
## ------  ----------  ------------
##    GOA       Chum     annual_sst
##    GOA    Sockeye   annual_sst_3
##    GOA       Coho   annual_sst_3
##    GOA  Pink even   annual_sst_3
##    GOA   Pink odd   winter_sst_3
##    NBC       Chum   annual_sst_3
##    NBC    Sockeye   annual_sst_3
##    NBC       Coho   winter_sst_3
##    NBC  Pink even   annual_sst_3
##    NBC   Pink odd   annual_sst_3
...
## GOA Chum
gam_time_sst_goa_chum <- fit_gam_list(dat_goa_chum, covars, time = TRUE)
save(gam_time_sst_goa_chum, file = "./outputs/gam_time_sst_goa_chum.RData")

## GOA Sockeye
gam_time_sst_goa_sockeye <- fit_gam_list(dat_goa_sockeye, covars, time = TRUE)
save(gam_time_sst_goa_sockeye, file = "./outputs/gam_time_sst_goa_sockeye.RData")

## GOA coho
gam_time_sst_goa_coho <- fit_gam_list(dat_goa_coho, covars, time = TRUE)
save(gam_time_sst_goa_coho, file = "./outputs/gam_time_sst_goa_coho.RData")

## GOA Pink Even
gam_time_sst_goa_pink_even <- fit_gam_list(dat_goa_pink_even, covars, time = TRUE)
save(gam_time_sst_goa_pink_even, file = "./outputs/gam_time_sst_goa_pink_even.RData")

## GOA Pink Odd
gam_time_sst_goa_pink_odd <- fit_gam_list(dat_goa_pink_odd, covars, time = TRUE)
save(gam_time_sst_goa_pink_odd, file = "./outputs/gam_time_sst_goa_pink_odd.RData")


## NBC Chum
gam_time_sst_nbc_chum <- fit_gam_list(dat_nbc_chum, covars, time = TRUE)
save(gam_time_sst_nbc_chum, file = "./outputs/gam_time_sst_nbc_chum.RData")

## NBC Sockeye
gam_time_sst_nbc_sockeye <- fit_gam_list(dat_nbc_sockeye, covars, time = TRUE)
save(gam_time_sst_nbc_sockeye, file = "./outputs/gam_time_sst_nbc_sockeye.RData")

## NBC Coho
gam_time_sst_nbc_coho <- fit_gam_list(dat_nbc_coho, covars, time = TRUE)
save(gam_time_sst_nbc_coho, file = "./outputs/gam_time_sst_nbc_coho.RData")

## NBC Pink Even
gam_time_sst_nbc_pink_even <- fit_gam_list(dat_nbc_pink_even, covars, time = TRUE)
save(gam_time_sst_nbc_pink_even, file = "./outputs/gam_time_sst_nbc_pink_even.RData")

## NBC Pink Odd
gam_time_sst_nbc_pink_odd <- fit_gam_list(dat_nbc_pink_odd, covars, time = TRUE)
...
for(i in 1:nrow(best_gam_time)) {
    m <- best_gam_time[i, ]
    dat_best_gam_time[[i]] <- catch[catch$region == m$region & catch$species == m$species, ## TODO
                           c("region", "species", unlist(m$data_vars))]
